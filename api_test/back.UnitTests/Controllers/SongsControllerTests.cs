...
namespace back.Tests.Controllers
{
  public class SongsControllerTests
  {
    ...
    private readonly Mock<IYoutubeDataService> _youtubeDataServiceMock;
    ...
    public SongsControllerTests()
    {
      ...
      _youtubeDataServiceMock = new Mock<IYoutubeDataService>();
      ...
      _sut = new SongsController(
        ...
        _youtubeDataServiceMock.Object,
        _loggerMock.Object,
    ...
    [Fact]
    public void Constructor_WhenYoutubeDataServiceIsNull_ShouldThrowArgumentNullException()
    {
      // Act & Assert
      Assert.Throws<ArgumentNullException>(() =>
        new SongsController(
    ...
    [Fact]
    public void Constructor_WhenHubContextIsNull_ShouldThrowArgumentNullException()
    {
      // Act & Assert
      Assert.Throws<ArgumentNullException>(() =>
        new SongsController(
    ...
    public async Task AddSong_WithValidSongAndTeam_ShouldReturnCreatedAtAction()
    {
      ...
      // Add YoutubeDataService mock setup
      _youtubeDataServiceMock
        .Setup(x => x.GetVideoDataAsync(song.Link))
        .ReturnsAsync(new YouTubeVideoData { Title = "New Song", Author = "Test Artist", DurationSeconds = 225 });
    ...
    public async Task AddSong_WithInsertAfterCurrentTrue_ShouldInsertAfterCurrentSong()
    {
      ...
      _youtubeValidatorMock
        ...
        .Returns(Task.CompletedTask);
      _youtubeDataServiceMock
        .Setup(x => x.GetVideoDataAsync(newSong.Link))
        .ReturnsAsync(new YouTubeVideoData { Title = "New Song", Author = "Test Artist", DurationSeconds = 225 });
      _teamsRepositoryMock
        .Setup(x => x.GetByIdAsync(teamId))
        .ReturnsAsync(team);
    ...
    public async Task AddSong_WithNoExistingSongs_ShouldSetIndexToZero()
    {
      ...
      _youtubeDataServiceMock
        .Setup(x => x.GetVideoDataAsync(song.Link))
        .ReturnsAsync(new YouTubeVideoData { Title = "First Song", Author = "Test Artist", DurationSeconds = 225 });
      _teamsRepositoryMock
        .Setup(x => x.GetByIdAsync(teamId))
        .ReturnsAsync(team);
      _songsRepositoryMock
    ...
    #region SetPlayState Tests

    [Fact]
    public async Task SetPlayState_WhenTeamNotFound_ShouldReturnNotFound()
    {
      // Arrange
      int teamId = 999;
      var request = new SongsController.PlayStateRequest { IsPlaying = true, Position = 0 };
      ...
      // Act
      var result = await _sut.SetPlayState(teamId, request);
    ...
    [Fact]
    public async Task SetPlayState_WhenStartingPlayback_ShouldUpdateTeamPlayState()
    {
      // Arrange
      int teamId = 1;
      var team = new Team { Id = teamId, Name = "Test Team", IsPlaying = false };
      var request = new SongsController.PlayStateRequest { IsPlaying = true, Position = 0 };
      ...
      _teamsRepositoryMock
        ...
        .ReturnsAsync(team);
      _teamsRepositoryMock
        .Setup(x => x.UpdateAsync(teamId, It.IsAny<Team>()))
        .ReturnsAsync(team);

      var clientProxyMock = new Mock<IClientProxy>();
      _hubContextMock
        .Setup(x => x.Clients.Group(teamId.ToString()))
      ...
      okResult.StatusCode.Should().Be(200);
      _teamsRepositoryMock.Verify(x => x.UpdateAsync(teamId, It.IsAny<Team>()), Times.Once);
    }

    [Fact]
    public async Task SetPlayState_WhenStoppingPlayback_ShouldUpdateTeamPlayState()
    {
      // Arrange
      int teamId = 1;
      var team = new Team { Id = teamId, Name = "Test Team", IsPlaying = true, StartedAtUtc = DateTime.UtcNow };
      var request = new SongsController.PlayStateRequest { IsPlaying = false, Position = 10 };
    ...
    [Fact]
    public async Task SetPlayState_WhenAlreadyPlayingAndSetToPlay_ShouldUpdateButNotChangeState()
    {
      // Arrange
      int teamId = 1;
      var startTime = DateTime.UtcNow.AddSeconds(-30);
      var team = new Team { Id = teamId, Name = "Test Team", IsPlaying = true, StartedAtUtc = startTime };
      var request = new SongsController.PlayStateRequest { IsPlaying = true, Position = 0 };
      ...
      // Assert
      result.Result.Should().BeOfType<OkResult>();
      _teamsRepositoryMock.Verify(x => x.UpdateAsync(It.IsAny<int>(), It.IsAny<Team>()), Times.Once);
    }

    [Fact]
    public async Task SetPlayState_WhenAlreadyStoppedAndSetToStop_ShouldUpdateButNotChangeState()
    {
      // Arrange
      int teamId = 1;
      var team = new Team { Id = teamId, Name = "Test Team", IsPlaying = false, StartedAtUtc = null };
      var request = new SongsController.PlayStateRequest { IsPlaying = false, Position = 0 };
    ...
    #region GetPlayState Tests

    [Fact]
    public async Task GetPlayState_WhenTeamNotFound_ShouldReturnNotFound()
    {
      // Arrange
      int teamId = 999;
      ...
      // Act
      var result = await _sut.GetPlayState(teamId);
    ...
    [Fact]
    public async Task GetPlayState_WhenTeamIsPlaying_ShouldReturnPlayState()
    {
      // Arrange
      int teamId = 1;
      var startTime = DateTime.UtcNow.AddSeconds(-30);
    ...
    [Fact]
    public async Task GetPlayState_WhenTeamIsNotPlaying_ShouldReturnPlayState()
    {
      // Arrange
      int teamId = 1;
      var team = new Team
