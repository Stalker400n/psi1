...
namespace back.Tests.Controllers
{
  public class TeamsControllerTests
  {
    ...
    public TeamsControllerTests()
    {
      ...
      _sut = new TeamsController(_teamsRepositoryMock.Object, _loggerMock.Object);
    }
    ...
    public void Constructor_WhenTeamsRepositoryIsNull_ShouldThrowArgumentNullException()
    {
      ...
      Assert.Throws<ArgumentNullException>(() =>
        new TeamsController(null!, _loggerMock.Object));
    }
    ...
    public void Constructor_WhenLoggerIsNull_ShouldThrowArgumentNullException()
    {
      // Act & Assert
      Assert.Throws<ArgumentNullException>(() =>
        new TeamsController(_teamsRepositoryMock.Object, null!));
    }
    ...
    #region GetQueueHistory Tests

    [Fact]
    public async Task GetQueueHistory_WithValidTeamId_ShouldReturnQueueHistory()
    {
      // Arrange
      int teamId = 1;
      var songs = new List<Song>
            {
                ...
                new Song { Id = 3, Title = "Song 3", Link = "https://youtube.com/watch?v=test3", Index = 2 }
            };
      var team = new Team
      {
        Id = teamId,
      ...
      // Act
      var result = await _sut.GetQueueHistory(teamId);
    ...
    [Fact]
    public async Task GetQueueHistory_WhenTeamNotFound_ShouldReturnNotFound()
    {
      // Arrange
      int teamId = 999;
    ...
    [Fact]
    public async Task GetQueueHistory_WithEmptyQueue_ShouldReturnEmptyList()
    {
      // Arrange
      int teamId = 1;
      var team = new Team
    ...
    [Fact]
    public async Task GetQueueHistory_WhenExceptionThrown_ShouldReturnInternalServerError()
    {
      // Arrange
      int teamId = 1;
